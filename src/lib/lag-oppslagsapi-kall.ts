import { ApiError, getOppslagsAPIToken, getHeaders, getTraceIdFromRequest } from './next-api-handler';
...
type LagOppslagsApiKall = (url: string, opts: Opts) => NextApiHandler;
const lagOppslagsApiKall: LagOppslagsApiKall = (url, opts) => async (req, res) => {
    ...
    try {
        ...
        const respons = await fetch(url, {
            ...
            headers: brukerMock ? getHeaders('token', callId) : getHeaders(await getOppslagsAPIToken(req), callId),
