import { ArbeidssokerperioderResponse, ArbeidssokerPeriode } from '@navikt/arbeidssokerregisteret-utils';
...
function hentSisteArbeidssokerPeriode(arbeidssokerperioder: ArbeidssokerperioderResponse): ArbeidssokerPeriode {
    ...
    const aapneArbeidssokerperioder = arbeidssokerperioder.filter(
        (periode: ArbeidssokerPeriode) => periode.avsluttet === null,
    );
