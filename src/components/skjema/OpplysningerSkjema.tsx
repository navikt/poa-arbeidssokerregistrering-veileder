...
import { DinSituasjon } from '@/components/skjema/DinSituasjon';
import { Hindringer } from '@/components/skjema/Hindringer';
import { SisteJobb } from '@/components/skjema/SisteJobb';
import { Utdanning } from '@/components/skjema/Utdanning';
import { useModiaContext } from '@/contexts/modia-context';
import { registrerOpplysninger } from '@/lib/api/inngang-opplysninger';
import { startPeriode } from '@/lib/api/inngang-start-periode';
